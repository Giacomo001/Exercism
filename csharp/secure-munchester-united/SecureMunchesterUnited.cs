...
public class SecurityPassMaker
{
    public string GetDisplayName(TeamSupport support) => 
        support is SecurityJunior || support is SecurityIntern || support is PoliceLiaison ?
            $"{support.Title}" :            
        support is Security ? $"{support.Title} Priority Personnel" :
        support is Staff ? support.Title :
